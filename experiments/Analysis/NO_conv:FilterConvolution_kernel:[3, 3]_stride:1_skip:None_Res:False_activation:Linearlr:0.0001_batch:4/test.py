...
lightning_model = Model.load_from_checkpoint('/users/local/c23lacro/script/NO_Sentinel/runs/presentation_3129/NO_conv:FilterConvolution_kernel:[3, 3]_stride:1_skip:None_Res:False_activation:Linearlr:0.0001_batch:4/epoch=973-val_loss=0.00.ckpt').to(device)
