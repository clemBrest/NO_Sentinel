...
lightning_model = model.load_from_checkpoint(
                 '/users/local/c23lacro/script/2305/runs/22051754/1754/epoch=161-val_loss=0.00.ckpt'
                ).to(device)
...
plt.plot(time[0:50], mse_persistance[0:50], label='persistance')
plt.plot(time[0:50], mse_model[0:50], label='model')
plt.legend()
